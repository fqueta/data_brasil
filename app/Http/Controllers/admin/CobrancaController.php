...
class CobrancaController extends Controller
{
        ...
        //if($token_conta){
            ...
            if($verifica_fatura['acao']=='alertar'){
                ...
                if(Qlib::isAdmin(3)){
                    ...
                    $cont = Qlib::formatMensagemInfo('Sistema temporáriamente suspenso entre em contato com o administrador','danger');
                }
                die($cont);
            }
        //}
	...
	public function pararAlertaFaturaVencida(){
		$ret['exec']=false;
		if(isset($_SESSION[$this->tk_conta]['verifica_faturas']['acao'])){
			$_SESSION[$this->tk_conta]['verifica_faturas']['acao'] = 'liberar';
			$ret['exec']=true;
		}
		return $ret;
	}
